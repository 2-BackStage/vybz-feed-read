...
public class FanFeedReadRepositoryCustomImpl implements FanFeedReadRepositoryCustom {

    private final MongoTemplate mongoTemplate;

    @Override
    public List<FanFeedRead> findWithScroll(String sortType, String lastId, String writerUuid, int size) {
        ...
        return mongoTemplate.find(query, FanFeedRead.class);
    }
}
